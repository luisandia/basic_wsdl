 ...
 * generated in the com.service.luis package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOrdersRequest_QNAME = new QName("http://luis.service.com/", "getOrdersRequest");
    private final static QName _GetOrdersResponse_QNAME = new QName("http://luis.service.com/", "getOrdersResponse");
    private final static QName _CreateOrdersRequest_QNAME = new QName("http://luis.service.com/", "createOrdersRequest");
    private final static QName _CreateOrdersResponse_QNAME = new QName("http://luis.service.com/", "createOrdersResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.service.luis
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://luis.service.com/", name = "getOrdersRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://luis.service.com/", name = "getOrdersResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://luis.service.com/", name = "createOrdersRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://luis.service.com/", name = "createOrdersResponse")
