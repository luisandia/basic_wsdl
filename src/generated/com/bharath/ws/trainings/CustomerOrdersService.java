 ...
 * 2019-02-24T17:42:18.740-05:00
 * Generated source version: 3.0.2
 * 
 */
@WebServiceClient(name = "CustomerOrdersService", 
                  wsdlLocation = "file:/home/zafiron/shared/wsdlfirstws/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl",
...
public class CustomerOrdersService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/zafiron/shared/wsdlfirstws/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerOrdersService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/zafiron/shared/wsdlfirstws/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl");
        }
        WSDL_LOCATION = url;
    }
